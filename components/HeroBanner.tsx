        ...
        {SLIDES.map((slide) => (
          <div key={slide.id} className="w-full flex-shrink-0 h-full relative">
            ...
            <div className="relative z-10 h-full flex flex-col justify-center items-center text-center text-white px-6">
              ...
              <button className="bg-white text-primary font-bold px-8 py-3 rounded-full shadow-lg hover:bg-gray-50 transition-colors transform hover:scale-105 active:scale-95">
                {slide.buttonText}
              </button>
            </div>
          </div>
